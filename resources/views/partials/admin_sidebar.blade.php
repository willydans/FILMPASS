{{-- 
  ...
  INI ADALAH VERSI REVISI FINAL YANG SESUAI DENGAN LAYOUT BARU ANDA
--}}
...
<aside id="sidebar" class="sidebar bg-white border-r border-gray-200 p-6 flex flex-col justify-between fixed h-full z-30 lg:block">
    <div>
        ...
        <nav class="space-y-2">
            ...
            {{-- Menggunakan rute 'admin.studios.index' (plural) yang benar --}}
            ...
            {{-- Menggunakan rute 'admin.schedules.index' (plural) yang benar --}}
