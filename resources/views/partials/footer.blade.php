<footer class="bg-slate-800 border-t border-t-slate-700 mt-24 pt-16 pb-8">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        
        <div class="md:col-span-2">
            <h3 class="text-2xl font-bold text-white mb-2">FilmPass</h3>
            <p class="text-gray-400 text-sm mb-4 max-w-sm">
                Platform pemesanan tiket bioskop online terpercaya. Nikmati kemudahan nonton film favorit Anda dengan kualitas terbaik.
            </p>
        ...
        <div>
            ...
            <ul class="space-y-2">
                <li><a href="#" class="text-gray-400 hover:text-white text-sm transition-colors">Pusat Bantuan</a></li>
                <li><a href="#" class="text-gray-400 hover:text-white text-sm transition-colors">Hubungi Kami</a></li>
