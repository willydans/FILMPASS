...
<body class="bg-gray-900 min-h-full-screen text-white">
    ...
    <!-- Konten Utama: Form Masuk --><div class="flex flex-col items-center justify-center min-h-full-screen py-10">
        ...
        <!-- Form Container Tengah --><div class="bg-black bg-opacity-80 p-8 sm:p-16 rounded-lg w-full max-w-md shadow-2xl">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4"> 
                ...
                <!-- Tombol Sign In (Warna Merah Khas) --><button
                    type="submit"
            ...
            <!-- Opsi dan Tautan Bawah (Tanpa "Remember me" karena tidak ada "Need Help?") --><div class="flex justify-start items-center text-sm mt-3 mb-8">
                <!-- Checkbox "Remember me" --><div class="flex items-center">
            ...
            <!-- Tautan "Sign up now" --><div class="text-gray-400 mt-4 text-base">
                New to FilmPass? 
