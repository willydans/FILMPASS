...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Jadwal Tayang</h1>
        <p class="text-gray-600">Buat jadwal pemutaran film baru</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200 p-8">
        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                @if($studios->count() == 0)
                    <p class="text-xs text-red-500 mt-1">Tidak ada studio aktif. Aktifkan studio terlebih dahulu.</p>
                @endif
            </div>
            ...
            <div>
                ...
                >
                <p class="text-xs text-gray-500 mt-1">Jadwal harus dimulai setelah waktu saat ini</p>
            </div>
